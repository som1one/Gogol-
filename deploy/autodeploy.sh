...
# HTTPS, а не git@github.com: репозиторий публичный, и чтение по HTTPS не просит
# ни ключа, ни токена. По SSH выкат падал с Permission denied (publickey) — у
# root на сервере нет ключа, известного GitHub, и заводить его теперь незачем.
REPO="https://github.com/som1one/Gogol-.git"
BRANCH="main"
